import { TermsProps } from '../../utils/types/terms';

import classes from './terms.module.css';

export const Terms = ({ title }: TermsProps) => {
    const setTitle = (str: string): string => {
      if (str === 'terms') return 'Правила пользования';
      if (str === 'contract') return 'Договор оферты';
